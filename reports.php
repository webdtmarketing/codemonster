              ...
              <div>
                <a href="#close" title="Close" class="close">X</a>
                   ...
                   <div class="text-center mt-2 mb-4" bis_skin_checked="1">
                    <img src="assets/images/logos/reports.jpg" alt="" class="imagenlog" width="480"> 
                  </div>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12 inicio">
              <span class="help-header">Reports </span>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-lg-3">
                      <a href="#openEmail" class="btn" title="Comunícate con soporte técnico"><span class="help-center-text-color"> Visit help center</span><i class="fa fa-external-link" aria-hidden="true"></i></a>                      </div> 
                  </div>
                  <div class="row">
                    <div class="col-lg-4"><input class="form-control" id="rprimero" placeholder="(GTM + 01:00) Central European Time"></div>  
                    <div class="col-lg-4"><input class="form-control" placeholder="10/23/2023 -> 10/31/2023 " id="rsegundo"></div>  
                    <div class="col-lg-4"><input class="form-control" placeholder="All Campaigns" id="rtercero"></div>   
                  </div>
                  <br>
                  <div class="row">
                    <div class="col-lg-4">
                      <select class="form-select" aria-label="Default select example" id="rcuarto">
                    ...
                    <div class="col-lg-4"><button class="conec dos" id="rquinto">Export PDF</button><button class="conec dos" id="rsexto">Export CSV</button></div>  
                    <div class="col-lg-4"></div>   
                  </div>
                  <br>
                  <div class="row">
                    <img src="assets/images/logos/report.jpg" width="250" alt="" id="rseptino"/>
                  </div>
                  <div class="row">
                    <table class="table table-striped das">
                       <thead class="headtabl">
                      <tr class="headtable">
                        <th class="ini">Date</th>
                        <th>Views</th>
                        <th>Follows</th>
                        <th>Connections send</th>
                        <th>Messages send</th>
                        <th>InMails send</th>
                      </tr>
                      </thead>
                      <tr class="intertable">
                        <td><div class="form-check form-switch">2023-10-23</td>
                        <td>29</td>
                        <td>0</td>
                        <td>21</td>
                        <td>0</td>
                    ...
                    <tr class="intertable">
                        <td><div class="form-check form-switch">2023-10-24</td>
                        <td>30</td>
                        <td>0</td>
                        <td>12</td>
                        <td>0</td>
                    ...
                    <tr class="intertable">
                      <td><div class="form-check form-switch">2023-10-25</td>
                      <td>29</td>
                      <td>0</td>
                      <td>46</td>
                      <td>0</td>
                    ...
                    <tr class="intertable">
                      <td><div class="form-check form-switch"><strong>Total</strong></td>
